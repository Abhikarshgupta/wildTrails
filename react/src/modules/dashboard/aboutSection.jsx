	...
	return (
		<>
			<Stack rowGap={4} alignItems='center' style={{ padding: "2rem" }}>
				...
				<Stack rowGap={4} style={{ padding: "0 5rem" }}>
					...
					<StyledFlexContainer
						...
						<ol type='1'>
							...
							<li>
								On successful registration, please get in touch with us (East
								Africa:{" "}
								<a
							...
							<li>
								Once access is provided, Go to the home page & click on "Access
								my Rate table" followed by "Update my rate table"
							</li>
							<li>
								That’s it. Now you are all set. Your Safari-in-3clicks portal is
					...
					<StyledFlexContainer>
						It generates your safari itineraries in just 3 clicks. Just enter
						your rate card (just once) (see "How does it work"), then you key in
						the number of nights, number of people, and check-in date and click
						on generate itineraries and it will generate all possible
						itineraries with costing. All you have to do is pick the right
						itinerary and click "generate pdf" of that itinerary and then share
						it with your client. The itinerary pdf has all details including
						cost, cost-breakup (optional), detailed itinerary with images, and
						all activities.
					</StyledFlexContainer>
					<StyledFlexContainer flexStart fullWidth>
					...
					<StyledFlexContainer flexStart fullWidth>
						...
						safari itineraries for Africa. [Currently supporting only Kenya and
						Tanzania; Other African countries are coming soon and also India]
					</StyledFlexContainer>
					<StyledFlexContainer flexStart fullWidth>
						Contact Info:
					</StyledFlexContainer>
